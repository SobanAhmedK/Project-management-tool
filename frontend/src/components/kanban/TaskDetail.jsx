...
const TaskDetail = ({ task, onClose, onStatusChange, onTaskUpdate }) => {
  ...
  // Status mapping to align with ProjectBoard
  const statusMap = {
    todo: "todo",
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        if (task.status !== updatedTask.status && onStatusChange) {
  ...
  const canDeleteComment = (comment) => {
    return (
      currentUser.id === comment.commented_by.id || currentUser.role === "admin" || currentUser.role === "manager"
    );
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Error Message */}
        {error && (
          <div className="p-4 mx-6 mt-4 rounded-lg bg-rose-50 text-rose-700 border border-rose-200">
            {error}
          </div>
        )}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  {editMode ? (
                    ...
                    <div
                      className={`text-sm px-3 py-2 rounded-lg font-medium ring-1 flex items-center space-x-2 ${
                        statusData[reverseStatusMap[task.status]]?.color ||
                    ...
                    >
                      ...
                      <span>
                        ...
                        {reverseStatusMap[task.status] === "in-progress" &&
                          "In Progress"}
                ...
                <div>
                  ...
                  {editMode ? (
                    ...
                    <div
                      className={`text-sm px-3 py-2 rounded-lg font-medium ring-1 flex items-center space-x-2 ${
                        priorityData[task.priority]?.color ||
                        "bg-gray-100 text-gray-700 ring-gray-200"
                      }`}
                    >
